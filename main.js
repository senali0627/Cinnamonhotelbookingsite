...
bookingForm.addEventListener("input", function(evt) {
 ...
 // Add or update adventure booking details in the table
...
if (name && date && duration) {
  ...
  document.getElementById("bookingFormMain").reset();
...
// Get the "Add to Favorites" button reference
let addToFavoritesButton = document.getElementById("addtofavourites");
...
// Get the "Check Loyalty" button reference
let checkLoyaltyButton = document.getElementById("loyaltyPoints");
...
// Get the "Book Now" button reference
